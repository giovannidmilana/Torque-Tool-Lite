...
Torque-Tool-Lite
Torque-Tool-Lite is a lightweight Python client for Atlas Copco Open Protocol controllers.
It provides a simple, event-driven foundation for integrating torque tools into manufacturing systems, enabling:
- 🔧 Real-time tightening data collection
- 📋 Job control and dynamic job execution
- 📊 Historical result retrieval for traceability
- ⚙️ Full tool lifecycle commands for complete device management
Designed for seamless integration with MES/WMS systems, standard-work enforcement, and manufacturing data collection pipelines.
...
👉 Open Protocol Python Client for Atlas Copco Torque Tools
